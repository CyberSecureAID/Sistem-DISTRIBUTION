// ============================================================
//  ui/admin.js  — v3.0 (corregido)
//
//  CAMBIOS v3.0:
//  - Eliminada saveExecConfigAction() y todo lo relacionado
//    con "Configurar Acción de Ejecución". execute.html usa
//    siempre distributePublic() — no hay configuración que hacer.
//  - _refreshBalances() actualiza también #execTotalNeeded
//    (nuevo elemento en admin.html v3.0 que muestra el BNB
//    que debe enviar el operador al usar execute.html).
//  - Coherente con los cambios de provider.js v2.1 y admin.html v3.0.
// ============================================================
...
async function _refreshBalances() {
  try {
    ...
    if (contract) {
      ...
      // Actualizar el campo informativo de execute.html
